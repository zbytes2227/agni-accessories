      ...
      <div className="mt-8 flex sm:justify-end">
        <div className="w-full max-w-2xl sm:text-end space-y-2">
          <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
            ...
            <dl className="grid sm:grid-cols-5 gap-x-3">
              <dt className="col-span-3 font-semibold text-gray-800  "> GST</dt>
              <dd className="col-span-2 text-gray-500">₹{Product.GST}</dd>
            </dl>

            <dl className="grid sm:grid-cols-5 gap-x-3">
              <dt className="col-span-3 font-semibold text-gray-800  "> Discount</dt>
              <dd className="col-span-2 text-gray-500">- ₹{Product.Discount}</dd>
            </dl>
            <dl className="grid sm:grid-cols-5 gap-x-3">
        ...
        <>
            ...
            <div className="mt-20">
                ...
                <div className="flex items-center justify-center mb-2">
                    ...
                    <button onClick={handlePrint} href="" class="mx-3 relative inline-flex items-center justify-center p-0.5 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white">
                        <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white rounded-md group-hover:bg-opacity-0">
                            Print PDF
                        </span>
                    </button>
    ...
    <div class="sm:w-11/12 lg:w-3/4 mx-auto">
      ...
      <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl border-4">
        ...
        <div class="flex justify-between">
          <div>
           <Image height={110} width={110} src="/logo_main.png" className=""   />
          ...
          <div class="text-end">
            ...
            Agni Accessories<br/>
            Maa Danteswari Mandir<br/>
            Kusalpur, Raipur<br/>
            Chhattisgarh<br/>+91 9140226087<br/>
            </address>
          </div>
        </div>
        ...
        <div class="mt-8 grid sm:grid-cols-2 gap-3">
          <div>
            ...
            <h3 class="text-lg font-semibold text-gray-800 ">{Product.CustomerName}</h3>
            <address class="mt-2 not-italic text-gray-500">
           Contact: {Product.CustomerPhone}<br/>
            </address>
          </div>
  ...
  <div class="border border-gray-200 p-4 rounded-lg space-y-4">
    ...
    {getOrderDetails()}
        ...
        <div class="mt-4 sm:mt-6">
          <h4 class="text-md text-center text-gray-800  ">This is Computer Generated Bill. </h4>
          <h4 class="text-lg font-medium text-center text-gray-800  "> Thank you ! Visit Again !</h4>
