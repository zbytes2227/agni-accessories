      ...
      <div class="p-4 mx-auto container mt-5">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg h-screen">
          ...
          {filteredProducts.length > 0 ? ( <div>
            <table className="w-full mt-3 text-sm text-left rtl:text-right text-gray-500 hidden">
...
{filteredProducts.map((Product) => (
  <>
    <a href="#" class="block my-1.5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
      ...
      <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900">OrderID: {Product.OrderID}
      ...
      <p className="pb-1">Date: {Product.OrderDate}</p>
      <p className="pb-1">Total Amount: ₹{Product.Total}</p>
      <div className="flex mt-2">
      
      <a href={`orders/show?id=${Product.OrderID}`} type="button" class="px-3 me-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Invoice</a>
      <a  href={`products/edit?id=${Product.ProductID}`} type="button" class="px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</a>
        <button   onClick={() => (deleteMe(Product.OrderID))} type="button" class="px-3 mx-3 py-2 text-xs font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Delete</button>
      </div>
